...
void RC_start_Init (void){
  R.DDS_RX.Freq                 = 10000;                                        // Частота приема
  R.DDS_TX.Freq                 = 10000;                                        // Частота передачи
  ...
  R.AGC.Enable                  = 0;                                            // АРУ по умолчанию 1-включена 0-выключена
  R.TXAGC.Enable                = 0;                                            // АРУ по умолчанию 1-включена 0-выключена
